...
Make Your Own Arduino Shield is a hands-on course focused on practical Arduino
...
- Understand the core goals of the **Make Your Own Arduino Shield** lessons.
...
sensors/actuators described in the Make Your Own Arduino Shield videos, jumper wires, and
a USB cable for programming plus logging.
...
# Or upload via Arduino IDE to replicate the Make Your Own Arduino Shield lab
```
